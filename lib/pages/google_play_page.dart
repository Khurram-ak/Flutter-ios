...
class GooglePlayPage extends StatefulWidget {
  static const String route = '/google_play';

  @override
  _GooglePlayPageState createState() => _GooglePlayPageState();
}

class _GooglePlayPageState extends State<GooglePlayPage> {
