...
class SelectYourAirplaneView extends StatefulWidget {
  @override
  _SelectYourAirplaneViewState createState() => _SelectYourAirplaneViewState();
}

class _SelectYourAirplaneViewState extends State<SelectYourAirplaneView> {
          ...
          child: Stack(
            children: [
              Container(
                ...
                child: StreamBuilder(
                  stream: GetSubjects().getSubjects(), //
