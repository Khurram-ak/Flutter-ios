...
class FilterQuestionPage extends StatefulWidget {
  final subject;
  final categoryId;
  final title;
  final agFilter;
  ...
  @override
  _FilterQuestionPageState createState() => _FilterQuestionPageState();
}

class _FilterQuestionPageState extends State<FilterQuestionPage> {
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        children: [
                          ...
                          Visibility(
                            visible:
                                widget.quizzList[i].mediaType == 'IMAGE' ?? false,
                            child: SizedBox(
                              height: 250,
                              width: MediaQuery.of(context).size.width,
              ...
              Row(
                ...
                children: [
                  ...
                  new CircularPercentIndicator(
                    ...
                    lineWidth: 7.0,
                    percent: currentIndex.toDouble() / widget.quizzList.length,
                    center: new Text(
                      "$currentIndex",
                      style: TextStyle(
                        fontSize: 16,
